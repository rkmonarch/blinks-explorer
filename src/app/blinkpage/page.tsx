...
export default function BlinkPage() {
  ...
  return (
    <section className='mx-auto items-center w-full overflow-auto py-4 px-6'>
      <div className=' bg-black bg-opacity-[6%] rounded-3xl w-full flex items-center justify-center py-16'>
        <div className='w-full flex flex-col max-w-4xl md:flex-row items-stretch justify-around gap-10'>
          ...
          />
          <div className='w-full border border-red-500 md:w-1/2 flex flex-col justify-between'>
